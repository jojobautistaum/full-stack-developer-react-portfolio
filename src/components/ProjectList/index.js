...
import ontrack from '../../assets/images/projects/ontrack.jpg';
...
export default function ProjectList() {
  const projects = [
    ...
    {
      name: 'OnTrack Project Management',
      image: ontrack,
      githubUrl: 'https://github.com/Feortegas/OnTrack',
      deployedUrl: 'https://group2-ontrack.herokuapp.com/',
    },
    {
      name: 'Note Taker',
      image: note,
